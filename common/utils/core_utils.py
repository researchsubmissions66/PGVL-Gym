...
from common.utils.loss_utils import FocalLoss
...
class Accuracy_Logger(object):
    ...
    def get_overall_summary(self):
        """Return micro accuracy over every class accumulated so far."""
        correct = sum(item["correct"] for item in self.data)
        count = sum(item["count"] for item in self.data)
