...
class MultiheadAttention(Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False, kdim=None, vdim=None):
        ...
        # ``_LinearWithBias`` was a private PyTorch helper and was removed in
        # modern releases.  ``Linear`` has identical behaviour here.
...
class Hnsw:
    ...
    def fit(self, X):
        # nmslib is an optional extra used only by this graph-building method.
        # Importing it at use keeps it from becoming a hard import dependency.
        try:
            import nmslib
